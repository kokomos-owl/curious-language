          ...
          <div className="fo-who">
            ...
            <div className="fo-found">
              ...
              <p className="fo-found-body">
                Meaning is not held in the words, or even in the dimensions we chart<Footnote n="1">We&rsquo;ve presently employed 17 &lsquo;Actant-5&rsquo; and &lsquo;Predicate-12&rsquo; dimensions (based on established linguistic theory.)</Footnote>, but in how they couple &mdash; what creases to what, and what stays slack. Some couplings hold so tightly they move as one<Footnote n="2">transitivity and thematic-role depth &mdash; the grammar of who acts upon whom &mdash; couple so tightly they behave as a single thread, at correlations near 0.97&ndash;0.99.</Footnote>; others spread wide, pulling on everything around them<Footnote n="3">A dimension like animacy couples diffusely &mdash; a hub touching many others at once rather than locking to one.</Footnote>. And the reading is itself a coupling: whoever enters the text enters the same fabric, and acts and asserts through it and beyond it. We held this contour to a blind test<Footnote n="4">A prediction registered in advance and run on ~1,440 compositions of a corpus the instrument had never seen; it held on every count &mdash; including the one band we had predicted could not be resolved &mdash; across writing as far apart as eighteenth-century letters and present-day civic reports.</Footnote>, and it kept its shape &mdash; even where we had said it could not. So the document is not precious; the fabric goes on coupling past the last line, where every actor and every assertion is already expression.
              </p>
            </div>
            <hr className="fo-rule" />
            ...
            <p className="fo-more-body fo-more-body-tight">Curious implements through our nonprofit partner, <a href="https://www.habitatfdn.org/" target="_blank" rel="noopener noreferrer">Habitat Foundation</a>, a nonprofit public charity.</p>
