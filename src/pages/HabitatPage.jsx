  ...
  return (
    <div className="hp-scroll">
      ...
      <main className="hp-main">
        ...
        <p className="hp-abstract">
          <span className="hp-runin">In plain terms: Habitat observes the architecture of a community&rsquo;s textual expression.</span>{' '}
          It measures the structure of your writing — how it is built, and how its meaning holds together —
          and hands that measurement back. It is not sentiment analysis, and it is not generative AI: it
          does not score emotion, predict, summarize, or decide what your words mean. It is a substrate you
          build on, and what you build reads meaning without surrendering the words.
        </p>

        <details className="hp-sec">
          <summary className="hp-sec-sum">
            <span className="hp-sec-h">What it is</span>
            <span className="hp-sec-teaser">Habitat is a non-generative instrument.</span>
          </summary>
          <p className="hp-body">
            It runs two readings of a composition at once. One reads structure: who acts, what is asserted,
            who is affected. The other reads meaning: where the composition sits in a fixed semantic space.
            That second reading is a position, not a conversion: a reader that places your writing, never an
            agent that changes it.
          </p>
          <p className="hp-body">
        ...
        <details className="hp-sec">
          <summary className="hp-sec-sum">
            <span className="hp-sec-h">How it works</span>
            <span className="hp-sec-teaser"><strong>You compose.</strong> A composition enters the field.</span>
          </summary>
          <p className="hp-body">
            The act is yours, not the instrument&rsquo;s. Your words are read into structure and into a
            position in meaning, and they go no further: nothing generative ever receives them, and they
            never become training data. What enters the field is the measurement, not the text.
          </p>
          <p className="hp-body">
        ...
        <details className="hp-sec">
          <summary className="hp-sec-sum">
            <span className="hp-sec-h">What it returns</span>
            <span className="hp-sec-teaser">Habitat returns the contour of what it measured: the strongest couplings, the oppositions, where your structure concentrates, where it is still forming.</span>
          </summary>
          <p className="hp-body">
            A reading might say, for instance:{' '}
            <em>this composition contests who can act, leans hard on who is affected, and is silently
            unanimous about time.</em> When it puts a contour into words, it speaks only from the
            measurement, never from words it never received, never from a guess past where the measurement
            stops.
          </p>
          <p className="hp-body">
        ...
        <details className="hp-sec">
          <summary className="hp-sec-sum">
            <span className="hp-sec-h">Why this is sovereign</span>
            <span className="hp-sec-teaser">The sovereignty is structural, not a policy laid on top.</span>
          </summary>
          <p className="hp-body">
            ...
            The two readings never merge, so the instrument cannot collapse into a generated answer. The
            field never resolves, so it never returns a verdict. You compose; the instrument observes; the
        ...
        <details className="hp-sec">
          <summary className="hp-sec-sum">
            <span className="hp-sec-h">Build on it</span>
            <span className="hp-sec-teaser">Reading your own work is one thing built on Habitat, not the whole of it.</span>
          </summary>
          <p className="hp-body">
            Habitat is a substrate: you build components and web apps on it, and because the interface is
            sovereign, what you build reads meaning without ever surrendering the words. Among the things
            people build:
          </p>
          <ul className="hp-list">
            <li><strong>Readers and publications</strong> &mdash; pieces read on the substrate as you compose with them.</li>
            <li><strong>Organizational self-reading</strong> &mdash; a body sees what its work expresses, without handing the corpus to a model.</li>
            <li><strong>Civic and deliberation surfaces</strong> &mdash; every voice in a process held intact and handed back, not collapsed into consensus.</li>
            <li><strong>Sovereign middleware</strong> &mdash; Habitat between a team and the models they use: it measures; the words never cross.</li>
          </ul>
        </details>

        <details className="hp-sec">
          <summary className="hp-sec-sum">
            <span className="hp-sec-h">How far this is proven</span>
            <span className="hp-sec-teaser"><strong>Established:</strong> the instrument works on a real corpus.</span>
          </summary>
          <p className="hp-body">
            When structure is allowed to vary with meaning, the coupling between them forms and carries
            signal, and the instrument can tell a dimension your writing actively contests from one it is
            silently unanimous about. The mechanism that keeps the two readings from collapsing holds. The
            physical qualities of the field &mdash; where it concentrates, how stiff it is, what it holds
            ready &mdash; are measured from the field&rsquo;s own movement, not borrowed as metaphor.
          </p>
          <p className="hp-body">
...
<p className="hp-attrib">
      ...
      <style>{`
        ...
        /* Abstract / standfirst — plain-terms what-it-is and what-it-isn't, for busy
           readers; marked with a sienna rule so it reads as the summary. */
        .hp-abstract {
          font-family: "EB Garamond", Georgia, serif;
          font-size: 1.3rem;
          font-weight: 500;
        ...
        .hp-list li strong { color: #1a1a1a; }

        /* Run-in lead for the abstract — the accent-colored opening sentence. */
        .hp-runin { color: #b65a36; font-weight: 600; }

        /* Sections as collapsed accordions: subhead + first sentence always shown;
           the rest opens on click. Layered by interest — native <details>, no JS. */
        .hp-sec {
        ...
        .hp-sec-sum::-webkit-details-marker { display: none; }
        .hp-sec-h {
          display: block;
          font-family: "EB Garamond", Georgia, serif;
          font-weight: 600;
        ...
        .hp-sec[open] > .hp-sec-sum .hp-sec-h::before { content: "–"; }
        .hp-sec-teaser {
          display: block;
          font-family: "EB Garamond", Georgia, serif;
          font-size: 1.23rem;
        ...
        .hp-sec-teaser strong { color: #1a1a1a; }
        .hp-sec[open] > .hp-sec-sum { margin-bottom: 0.9rem; }
        .hp-sec .hp-body:first-of-type { margin-top: 0; }
        .hp-body {
          font-family: "EB Garamond", Georgia, serif;
          font-size: 1.23rem;
          font-weight: 500;
